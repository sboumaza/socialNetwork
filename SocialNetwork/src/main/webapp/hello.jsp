...
<body>
	...
	<nav
		class="navbar boxShadow fixed-top navbar-inverse  navbar-toggleable-md navBarWhiteBorder"
		style="background-color:#A901DB; padding-left: 50px; padding-right: 50px; height:45px;">


	<div class="collapse navbar-collapse mx-auto" id="navbarSupportedContent">
		<a class="navbar-brand mx-auto" style="font-size: 25px;" href="#">Bonjour
			Samir</a>
			
			<ul class="navbar-nav mx-auto">
			<li class="nav-item" ><a
				class="nav-link active" href="#"> <i class="fa fa-home" style="font-size: 25px;"
					 aria-hidden="true"> </i> Home </a></li>
			<li class="nav-item " ><a
				class="nav-link" href="#"><i class="fa fa-user" style="font-size: 25px;"
					aria-hidden="true"></i> Profile</a></li>
			<li class="nav-item " ><a
				class="nav-link" href="#"><i class="fa fa-comments-o" style="font-size: 25px;"
					aria-hidden="true"></i> Message</a></li>
			<li class="nav-item " ><a
				class="nav-link" href="#"><i class="fa fa-sign-out" style="font-size: 25px;"
					aria-hidden="true"></i> Déconnexion</a></li>
			<li class="nav-item" ><a
				class="nav-link" href="#"> <i class="fa fa-paperclip" style="font-size: 25px;"
					aria-hidden="true"></i>
	...
	<div class="container-fluid"
		style="margin-left: 50px; margin-right: 50px; margin-top: 80px;">
			...
			<div class="col-md-7 col-xl-7">
				...
				<div class="card boxShadow">
					...
					<div class="card-block nopadding">
						<form>
							...
							<textarea placeholder="Dis nous tout" rows="2"
				...
				<div class="card boxShadow">
					...
					<div class="card-block nopadding ">
						...
						<p style="padding-left: 12px; padding-right: 12px;">Le Lorem
